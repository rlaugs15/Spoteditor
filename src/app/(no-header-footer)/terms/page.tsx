      ...
      <div className="max-w-[724px] w-full">
        ...
        <section className="px-4 py-10 text-text-sm text-light-600 space-y-6">
          ...
          <ul className="pl-5 space-y-1">
            ...
            <li>
              ② "이용자"라 함은 본 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을
              말합니다.
            </li>
            <li>
              ③ "회원"이라 함은 회사에 개인정보를 제공하여 회원등록을 한 자로서, 회사의 정보를
              지속적으로 제공받으며 회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자를
              말합니다.
            </li>
            <li>
              ④ "로그"란 이용자가 자신이 방문한 장소에서 직접 촬영한 사진과 이에 대한 설명을 포함한
              게시물을 말합니다.
            </li>
            <li>
              ⑤ "콘텐츠"란 이용자가 서비스 상에 게시한 모든 글과 사진, 이미지, 영상 등 일체의 정보나
              자료를 의미합니다.
            </li>
          </ul>
          ...
          <ul className="pl-5 space-y-1">
            ...
            <li>
              ...
              사항은 별도의 '개인정보 처리방침'으로 정하며, 이는 서비스 내에서 확인하실 수 있습니
              다.
            </li>
