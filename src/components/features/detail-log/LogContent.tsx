...
const LogContent = () => {
  return (
    <div className="grid grid-cols-[1fr_4fr] gap-[15px] border-t pt-3 py-10">
      <section className="flex flex-col gap-2 relative">
        <div className="text-text-2xl font-bold flex flex-col">
          <span>01</span>
          <span>서촌 베란다</span>
        </div>
        <div>
          <div className="flex gap-1.5 text-light-400 text-text-lg">
            <ClockIcon />
            <span>카테고리</span>
          </div>
          <div className="flex gap-1.5 text-light-400 text-text-lg">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="text-text-lg text-light-400">
