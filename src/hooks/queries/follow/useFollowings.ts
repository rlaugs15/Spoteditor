...
async function fetchFollowing({ userId, currentPage, pageSize }: FollowParams) {
...
export default function useFollowings({ userId, currentPage = 1, pageSize = 10 }: FollowParams) {
